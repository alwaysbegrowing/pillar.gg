  ...
  try {
    ...
    if (result) {
      ...
      const userInfo = {
        ...
        twitch_access_token: twitch_credentials?.access_token
      }
      ...
      // stripe account has been created and all above information is valid
        ...
        await addUser(email, twitch_id, username, twitch_profile_picture, stripeCustomerID, twitch_credentials, timestamp, plan);
