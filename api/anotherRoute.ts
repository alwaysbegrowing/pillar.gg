...
const testTwitchEmail = async (req: NowRequest, res: NowResponse) => {
  const result = await getTwitchEmail('fi0lif535gxxk7xn2coeep3ggdz8p3');
  res.send(result);
};
...
module.exports = testTwitchEmail;
