...
describe('modes', () => {
  ...
  describe('mode2', () => {
    it('should return prev if key order has changed', () => {
      const prev = [
        { key: 'key-1', val: 100 , metadata: {num: 1}},
        { key: 'key-2', val: 200 , metadata: {num: 1}},
      ];
    ...
    it('should return prev if the change would result in two keys with same value', () => {
      ...
      const next1 = [
        { key: 'key-1', val: 100, metadata: {num: 1} },
        { key: 'key-2', val: 100, metadata: {num: 1} },
      ];
      ...
      const prev2 = [
        { key: 'key-1', val: 100 , metadata: {num: 1}},
        { key: 'key-2', val: 200 , metadata: {num: 1}},
        { key: 'key-3', val: 300 , metadata: {num: 1}},
      ];
      const next2 = [
        { key: 'key-1', val: 100 , metadata: {num: 1}},
        { key: 'key-2', val: 100 , metadata: {num: 1}},
    ...
    it('should return next if values are different and they would NOT change order', () => {
      ...
      const next1 = [
        { key: 'key-1', val: 100 , metadata: {num: 1}},
        { key: 'key-2', val: 300 , metadata: {num: 1}},
      ];
  ...
  describe('mode3', () => {
    it('should move the other value by a step if there is a conflict', () => {
      const prev = [
        { key: 'key-1', val: 50 , metadata: {num: 1}},
        { key: 'key-2', val: 75 , metadata: {num: 1}},
      ];
      const next = [
        { key: 'key-1', val: 75 , metadata: {num: 1}},
        { key: 'key-2', val: 75 , metadata: {num: 1}},
      ];
    ...
    it('should move the other value in the correct direction', () => {
      ...
      const next = [
        { key: 'key-1', val: 50 , metadata: {num: 1}},
        { key: 'key-2', val: 50 , metadata: {num: 1}},
      ];
    ...
    it('should also clear any conflicts created by the first move', () => {
      const prev = [
        { key: 'key-1', val: 45 , metadata: {num: 1}},
        { key: 'key-2', val: 50 , metadata: {num: 1}},
        { key: 'key-3', val: 75 , metadata: {num: 1}},
      ];
      const next = [
        { key: 'key-1', val: 45 , metadata: {num: 1}},
        { key: 'key-2', val: 50 , metadata: {num: 1}},
        { key: 'key-3', val: 50 , metadata: {num: 1}},
      ];
    ...
    it('should return the current state if all conflicts cannot be resolved', () => {
      ...
      const prev = [
        { key: 'key-6', val: 0 , metadata: {num: 1}},
        { key: 'key-5', val: 5 , metadata: {num: 1}},
        { key: 'key-4', val: 10 , metadata: {num: 1}},
        { key: 'key-3', val: 15 , metadata: {num: 1}},
        { key: 'key-2', val: 20 , metadata: {num: 1}},
        { key: 'key-1', val: 25 , metadata: {num: 1}},
      ];
      const next = [
        { key: 'key-6', val: 0 , metadata: {num: 1}},
        { key: 'key-5', val: 5 , metadata: {num: 1}},
        ...
        { key: 'key-3', val: 15 , metadata: {num: 1}},
        { key: 'key-2', val: 20 , metadata: {num: 1}},
        { key: 'key-1', val: 20 , metadata: {num: 1}},
      ];
    ...
    it('should resolve correctly this chain of changes', () => {
      ...
      const prev = [
        { key: 'key-1', val: 30 , metadata: {num: 1}},
        { key: 'key-2', val: 25 , metadata: {num: 1}},
        { key: 'key-3', val: 20 , metadata: {num: 1}},
        { key: 'key-4', val: 15 , metadata: {num: 1}},
        { key: 'key-5', val: 10 , metadata: {num: 1}},
        { key: 'key-6', val: 5 , metadata: {num: 1}},
      ];
      const next = [
        { key: 'key-1', val: 25 , metadata: {num: 1}},
        { key: 'key-2', val: 25 , metadata: {num: 1}},
